                ...
                <div className="space-y-4 p-4 md:p-5">
                  {messages.length === 0 ? (
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`min-w-0 w-fit max-w-[75%] rounded-md border px-3 py-2.5 text-sm text-foreground transition-shadow ${mine ? "shadow-[inset_3px_0_0_hsl(var(--primary)/0.55)]" : ""} ${isHighlighted ? "ring-2 ring-primary shadow-[0_0_0_4px_hsl(var(--primary)/0.15)]" : ""} [overflow-wrap:anywhere]`}
                          style={bubbleTheme}
                        >
